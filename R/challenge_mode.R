...
#' @param realm realm name. if not provided or NULL, will use region_leaderboard
#'
#' @details
#' \describe{
#'  \item{realm_leaderboard}{The data in this request has data for all 9 challenge mode maps
...
#'  \item{region_leaderboard}{The region leaderboard has the exact same data format as the
